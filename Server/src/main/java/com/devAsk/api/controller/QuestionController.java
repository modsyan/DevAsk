...
public class QuestionController {
    ...
    public ResponseEntity<QuestionResponse> Create(@RequestBody CreateEditQuestionRequest dto) {
    ...
    public ResponseEntity<QuestionResponse> Edit(@PathVariable long id, @RequestBody CreateEditQuestionRequest dto) {
